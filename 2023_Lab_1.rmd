...
```{r}
# Column titles are renamed for easier coding
...
# Recoding Question G = The top answer "Strongly disagree" = 6 would result in neg correlations with Question E, F, and G. We need to recode
